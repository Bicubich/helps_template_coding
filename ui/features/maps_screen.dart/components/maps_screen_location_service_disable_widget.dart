...
class MapsScreenLocationServiceDisableWidget extends StatelessWidget {
  const MapsScreenLocationServiceDisableWidget({super.key});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            LocaleKeys.kTextEnableLocationServices.tr(),
